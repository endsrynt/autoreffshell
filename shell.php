...
echo "\e[0;33m[2]\e[0m Shell Creator Account Automatic OTP (SMS Activate RU)\n\n";
...
if ($pilihan == 1) {
    ...
    $data = '{"mobile":"62'.$phoneNumber.'","brand":"SHELLINDONESIALIVE","deviceId":"B4282A18-FCCC-4B31-A2E8-C75BE2AF2899"}';
    ...
    $data = '{"brand":"SHELLINDONESIALIVE","mobile":"62'.$phoneNumber.'","sessionId":"'.$sessionId.'","deviceId":"B4282A18-FCCC-4B31-A2E8-C75BE2AF2899"}';
    ...
    $data = '{"brand":"SHELLINDONESIALIVE","deviceId":"B4282A18-FCCC-4B31-A2E8-C75BE2AF2899","sessionId":"'.$sessionId.'","otp":"'.$otpAnda.'","mobile":"62'.$phoneNumber.'"}';
    ...
    $headers = [
        ...
        'Accept-Language: id',
        'User-Agent: ShellGoPlus%20Production/17 CFNetwork/1312 Darwin/21.0.0',
        'Cap_device_id: B4282A18-FCCC-4B31-A2E8-C75BE2AF2899',
        'Connection: close',
    ];
    ...
    while(true) {
        ...
        $data = '{"mobile":"'.$phoneNumber.'","brand":"SHELLINDONESIALIVE","deviceId":"B4282A18-FCCC-4B31-A2E8-C75BE2AF2899"}';
        $getSession = curl('https://apac2-auth-api.capillarytech.com/auth/v1/token/generate', $data, $headers);
        $sessionId = get_between($getSession[1], '"sessionId":"', '"');
        echo "\e[0;33m[!]\e[0m Has Found Session ID    : \e[0;32m$sessionId\e[0m\n";

        $data = '{"brand":"SHELLINDONESIALIVE","mobile":"'.$phoneNumber.'","sessionId":"'.$sessionId.'","deviceId":"B4282A18-FCCC-4B31-A2E8-C75BE2AF2899"}';
        $getOtp = curl('https://apac2-auth-api.capillarytech.com/auth/v1/otp/generate', $data, $headers);
        $message = get_between($getOtp[1], '"message":"', '"');
    ...
    try {
        ...
        $data = '{"brand":"SHELLINDONESIALIVE","deviceId":"B4282A18-FCCC-4B31-A2E8-C75BE2AF2899","sessionId":"'.$sessionId.'","otp":"'.$otpAnda.'","mobile":"'.$phoneNumber.'"}';
        $validationOtp = curl('https://apac2-auth-api.capillarytech.com/auth/v1/otp/validate', $data, $headers);
        $message = get_between($validationOtp[1], '"message":"', '"');
        $token = get_between($validationOtp[1], '"token":"', '",');
        if ($message == 'SUCCESS') {
